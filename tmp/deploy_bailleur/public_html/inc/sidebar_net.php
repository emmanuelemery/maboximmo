...
$dashUser    = $_sbBase . 'dashboard_net.php';
...
<aside class="mbi-sidebar">
    ...
    <div class="sb-group dash">
        ...
        <ul class="sb-nav">
            <li><a href="<?= htmlspecialchars($dashUser) ?>" class="<?= sb_active('dashboard_net.php') ?>"><span class="sb-icon">👤</span><span class="sb-label">Dashboard User</span></a></li>
