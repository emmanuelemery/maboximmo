...
<div class="page-header">
  ...
  <a href="?new=1" class="btn-new" style="margin-left:auto">+ Nouveau compte</a>
</div>
...
<table class="comptes">
  ...
  <tr><td colspan="7" style="text-align:center;padding:30px;color:#aaa;">
    Aucun compte bailleur — <a href="?new=1">Créer le premier</a>
  </td></tr>
  <?php else: ?>
  ...
  <tr>
    ...
    <td style="white-space:nowrap;">
      <a href="?edit=<?= (int)$b['id'] ?>" class="btn-sm btn-edit">✏️ Modifier</a>
