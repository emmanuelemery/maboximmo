...
-- Lot 4 / X — Seed v1 du référentiel des mentions légales
-- Date   : 2026-05-01
-- Source : docs/mentions_legales_supports.md (version 2026-05-01.v1)
-- Notes  :
--   - Brouillon fonctionnel — `valide_juridiquement = 0`.
--   - Doit être validé juridiquement avant passage en production stricte.
--   - Une seule version active à la fois (contrôle applicatif).
-- =============================================================================

-- Désactive toute version précédente avant d'activer la nouvelle.
UPDATE `mbi_supports_mentions_versions` SET `actif` = 0 WHERE `actif` = 1;

INSERT INTO `mbi_supports_mentions_versions`
  ...
  "par_type_support": {
    "affiche_vitrine": {
      "bloc_dur": [
        ...
        { "code": "AFFICHE_PRIX_HONORAIRES","regle": "prix_avec_sans_honoraires" },
