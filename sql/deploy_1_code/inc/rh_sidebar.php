...
<aside class="mbi-sidebar">
    ...
    <div class="sb-group info">
        ...
        <ul class="sb-nav">
            ...
            <?php endif; ?>
            <!-- Entretiens collaborateur dynamiques -->
    ...
    <div class="sb-group agency">
        ...
        <ul class="sb-nav">
            <li><a href="./rh_documents.php" class="<?= sbActive('rh_documents.php') ?>">
                <span class="sb-icon">📄</span><span class="sb-label">Documents société</span>
            </a></li>
    ...
    <div class="sb-group admin">
        <div class="sb-section<?= sbActiveSection(['rh_user.php','rh_user_add.php','societe.php','rh_entretien_admin.php','rh_mail_templates.php','rh_mails.php','rh_salaires_historiq.php','rh_conges_historiq.php']) ? ' section-active' : '' ?>">
            Administration
        ...
        <ul class="sb-nav">
            ...
            <li><a href="./rh_mail_templates.php" class="<?= sbActive('rh_mail_templates.php') ?>">
                <span class="sb-icon">✉️</span><span class="sb-label">Modèles de mails</span>
            </a></li>
            <li><a href="./dev_organisation.php" class="<?= sbActive('dev_organisation.php') ?>">
