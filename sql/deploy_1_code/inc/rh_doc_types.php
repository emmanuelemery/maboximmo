...
function rh_doc_types_defaults(): array {
    return [
        ...
        ['rubrique'=>'personne','type_key'=>'contrat',   'label'=>'Contrat de travail',           'obligatoire'=>1,'dispo'=>'public', 'ordre'=>2,'systeme'=>1],
        ['rubrique'=>'personne','type_key'=>'rib',       'label'=>'RIB',                          'obligatoire'=>1,'dispo'=>'admin',  'ordre'=>3,'systeme'=>1],
        ['rubrique'=>'personne','type_key'=>'photo',     'label'=>'Photo',                        'obligatoire'=>0,'dispo'=>'public', 'ordre'=>4,'systeme'=>0],
        ['rubrique'=>'personne','type_key'=>'diplome',   'label'=>'Diplôme',                      'obligatoire'=>0,'dispo'=>'public', 'ordre'=>5,'systeme'=>0],
        ['rubrique'=>'personne','type_key'=>'formation', 'label'=>'Formation',                    'obligatoire'=>0,'dispo'=>'public', 'ordre'=>6,'systeme'=>0],
        // vehicule
        ...
        ['rubrique'=>'societe','type_key'=>'rcp',          'label'=>'RCP',                   'obligatoire'=>0,'dispo'=>'public','ordre'=>3,'systeme'=>0],
        ['rubrique'=>'societe','type_key'=>'assurance_soc','label'=>'Assurance société',     'obligatoire'=>0,'dispo'=>'public','ordre'=>4,'systeme'=>0],
        ['rubrique'=>'societe','type_key'=>'entete',       'label'=>'En-tête courrier',      'obligatoire'=>0,'dispo'=>'public','ordre'=>5,'systeme'=>0],
        // rh
...
function rh_doc_types_load(PDO $pdo): array {
    ...
    // Seeder si vide
    $nb = (int)$pdo->query("SELECT COUNT(*) FROM rh_doc_types")->fetchColumn();
    if ($nb === 0) {
