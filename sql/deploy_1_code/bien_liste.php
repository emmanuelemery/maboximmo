...
<div class="mbi-main">
  ...
  <form class="bl-filters" method="get" action="">
    ...
    <?php if ($filterSearch !== '' || $filterType !== '' || $filterTransaction !== '' || $filterStatut !== ''): ?>
...
<div class="bl-modal-overlay" id="deleteModal">
  <div class="bl-modal">
    <h3>🗑️ Supprimer ce bien ?</h3>
    <p id="deleteModalText">Cette action est irréversible. Le bien et toutes ses données associées seront supprimés.</p>
    <div class="bl-modal-actions">
      <button class="bl-btn bl-btn-ghost" onclick="closeModal()">Annuler</button>
      <a id="deleteConfirmBtn" href="#" class="bl-btn" style="background:#cc5c58;color:#fff;box-shadow:0 4px 10px rgba(204,92,88,0.3);">Supprimer</a>
    </div>
  </div>
</div>
...
function confirmDelete(id, ref) {
    document.getElementById('deleteModalText').textContent =
        'Supprimer le bien "' + ref + '" ? Cette action est irréversible.';
