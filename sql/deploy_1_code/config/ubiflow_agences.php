...
if (!function_exists('ubiflow_agences_all')) {
    function ubiflow_agences_all(): array {
        ...
        $cache = [
            ...
            'chaponost' => [
                'id_agence'   => 4,
                'login_ftp'   => 'regie_emery_chaponost',
            ...
            'lyon_07' => [
                'id_agence'   => 3,
                'login_ftp'   => 'regie_emery_lyon_07',
                'nom'         => 'REGIE EMERY LYON 7',
                'code_postal' => '69007',
                'ville'       => 'LYON 07',
                'id_societe'  => 1,
                'actif'       => true,
            ...
            'chamalieres' => [
                'id_agence'   => 6,
                'login_ftp'   => 'emery_immo_chamalieres',
