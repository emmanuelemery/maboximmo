<?php
// sidebar_net.php — Composant sidebar MaBoxImmo / Module Net
// Inclusion : include 'sidebar_net.php';

$current_page = $current_page ?? ($_GET['page'] ?? 'dashboard');

$net_modules = [
  'annonces' => ['label' => 'Annonces publiées',   'color' => '#3a7ab8', 'icon' => 'web'],
  'portails' => ['label' => 'Portails & Diffusion', 'color' => '#3a7ea8', 'icon' => 'monitor'],
  'leads'    => ['label' => 'Leads & Contacts',     'color' => '#3a8290', 'icon' => 'user-plus'],
  'medias'   => ['label' => 'Médias & Photos',      'color' => '#3a8678', 'icon' => 'image'],
  'stats'    => ['label' => 'Statistiques',         'color' => '#3a8a60', 'icon' => 'bar-chart'],
];
...
$icons = [
  ...
  'user-plus' => '<path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/>',
...
<nav class="sb" aria-label="Navigation principale">
  ...
  <a href="bailleur_dashboard.php" class="sb-pill">
    <div class="sb-pill-ico"><?= svg_icon($icons['bailleur'], '#4e6e90') ?></div>
    <span class="sb-lbl">Bailleur</span>
  </a>

  <a href="net_dashboard.php" class="sb-pill active">
  ...
  <!-- NET -->
  <div class="sb-section">Net</div>

  <?php foreach ($net_modules as $key => $mod): ?>
  <a href="?page=<?= $key ?>"
