        ...
        <div class="tab-panel <?= $activeTab==='docs' ? 'active':'' ?>" id="tab-docs">
          <div class="form-section">
            <div class="form-section-title">
              📄 Mes documents
              <a href="./rh_documents_prov.php?user_id=<?= (int)$userId ?>" class="btn-add-doc" style="float:right;padding:4px 14px;background:#4878a6;color:#fff;border-radius:6px;font-size:11px;font-weight:600;text-decoration:none;font-family:'Sora',sans-serif">+ Ajouter un document</a>
            </div>
