...
<div class="sb-content">
    ...
    <main class="main">
        ...
        <!-- BAILLEUR -->
        <div class="sec-head">
            <span class="line-l" style="background:linear-gradient(90deg,transparent,#4a8074)"></span>
            <span class="sec-txt" style="background:linear-gradient(180deg,#5fa090 0%,#4a8074 50%,#2f5a50 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">Bailleur</span>
        ...
        <div class="cards-grid">
            <a href="bailleur_admin_comptes.php" class="adm-card" style="border-left-color:#4a8074">
                ...
                <div class="adm-card-label">Comptes bailleur</div>
                <div class="adm-card-desc">Créer les accès bailleurs, assigner leurs SCI/propriétaires et activer leurs modules (Patrimoine, GED, EDL, Transaction…).</div>
                <div class="adm-card-arrow" style="color:#4a8074">Gérer →</div>
            </a>
            <a href="bailleur_dashboard_v2.php" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                </div>
                <div class="adm-card-label">Tableau de bord bailleur</div>
                <div class="adm-card-desc">Vue super admin du portefeuille bailleurs : patrimoine, impayés, CRG, modules.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
            <a href="bailleur_patrimoine_actif.php" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg>
                </div>
                <div class="adm-card-label">Patrimoine actif</div>
                <div class="adm-card-desc">Immeubles, lots et locataires : loyers, impayés, taux d'occupation.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
            <a href="bailleur_ged.php" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
                </div>
                <div class="adm-card-label">GED Documents</div>
                <div class="adm-card-desc">CRG, baux, quittances et courriers classés automatiquement.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
            <a href="bailleur_revision_loyer.php" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
                </div>
                <div class="adm-card-label">Révision des loyers</div>
                <div class="adm-card-desc">Calcul IRL et génération du courrier de révision.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
            <a href="bail_360.php" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                </div>
                <div class="adm-card-label">Bail 360°</div>
                <div class="adm-card-desc">Fiche complète d'un bail : loyer, charges, dépôt, échéances.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
            <a href="annonce_liste.php" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><path d="M3 11l18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 11-5.8-1.6"/></svg>
                </div>
                <div class="adm-card-label">Diffusion annonce</div>
                <div class="adm-card-desc">Publication des biens à louer ou à vendre sur le site Ma Box Immo.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
            <a href="transaction_index.php?type=vente&amp;scope=bailleur" class="adm-card" style="border-left-color:#4a8074">
                <div class="adm-card-ico" style="background:rgba(74,128,116,0.1)">
                    <svg viewBox="0 0 24 24" stroke="#4a8074"><path d="M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                </div>
                <div class="adm-card-label">Transaction <span style="font-size:9px;color:#e65100">10 €/dossier</span></div>
                <div class="adm-card-desc">Vente d'un bien : dossier, acquéreurs, notaire, suivi signature.</div>
                <div class="adm-card-arrow" style="color:#4a8074">Ouvrir →</div>
            </a>
        </div>
