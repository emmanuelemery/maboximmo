...
<div class="wrap">
  ...
  <?php else: ?>
    ...
    <div class="card">
      ...
      <p>
        <a class="btn btn-primary" href="<?=mbisupp_h($result['fichier_pdf'])?>" target="_blank">
          Ouvrir le PDF
        </a>
        <a class="btn" style="background:#eef1f5;color:var(--navy);" href="<?=mbisupp_h($result['fichier_pdf'])?>" download>
          Télécharger
        </a>
      </p>
            ...
            <tr>
              ...
              <td>
                <?php if (!empty($h['fichier_pdf_path'])): ?>
                  <a href="<?=mbisupp_h($h['fichier_pdf_path'])?>" target="_blank">Ouvrir</a>
                <?php else: ?>
                  —
                <?php endif; ?>
              </td>
