<?php
/**
 * rh_frais_user.php — Page teaser « Notes de frais » (rôle user).
 *
 * Placeholder pour la future déclaration mensuelle des frais professionnels.
 */
...
.teaser-icon { width:72px; height:72px; border-radius:18px; background:linear-gradient(135deg,#8a5040,#6a3820); display:flex; align-items:center; justify-content:center; font-size:36px; box-shadow:4px 4px 12px #c8cbd2,-4px -4px 12px #fff; flex-shrink:0; }
...
<div class="teaser-card">
    <div class="teaser-hero">
        ...
        <div>
            <h2>Déclarer vos frais professionnels</h2>
            <p>Soumettez en quelques clics les frais engagés pour le compte de votre agence — remboursement simplifié et traçable.</p>
    ...
    <div class="teaser-body">
        ...
        <ul class="teaser-list">
            <li>
                <div class="check">✓</div>
                <div>
                    <strong>Photographier un reçu = déclaration instantanée</strong>
                    <span>Uploadez une photo de ticket : montant, date et catégorie extraits automatiquement.</span>
                </div>
            </li>
            <li>
                <div class="check">✓</div>
                <div>
                    <strong>Suivi du remboursement en temps réel</strong>
                    <span>Soumis · validé · payé : chaque note avance dans un pipeline visible par vous.</span>
                </div>
            </li>
            <li>
                <div class="check">✓</div>
                <div>
                    <strong>Export comptable automatique</strong>
                    <span>Tous vos justificatifs regroupés en un PDF mensuel transmis directement au comptable.</span>
                </div>
            </li>
            <li>
                <div class="check">✓</div>
                <div>
                    <strong>Zéro email, zéro papier</strong>
                    <span>Plus besoin de conserver les reçus pendant des semaines — tout est archivé et sécurisé.</span>
                </div>
            </li>
        </ul>
    </div>
