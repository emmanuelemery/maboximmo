...
<section id="services" class="services-section">
    ...
    <div class="services-grid">
        ...
        <a href="<?=($isLoggedIn && isset($userServices['agency'])) ? 'agency_dashboard.php' : '#'?>" data-service="agency" class="service-card <?=($isLoggedIn) ? (isset($userServices['agency']) ? 'active' : 'locked') : ''?>" onclick="<?=(!$isLoggedIn) ? 'event.preventDefault(); openLoginModal();' : ((!isset($userServices['agency'])) ? 'event.preventDefault();' : '')?>">
            <div class="service-icon">🏠</div>
