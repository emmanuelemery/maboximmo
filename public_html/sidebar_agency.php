...
<nav class="sb">
    ...
    <div class="sb-nav">
        ...
        <?php sbSI('dashboard', $current_page, 'agency_dashboard.php', 'Dashboard',
            '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>'); ?>
        <?php sbSI('immeubles', $current_page, 'agency_immeubles.php', 'Immeubles',
            '<path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>'); ?>
        <?php sbSI('mandants', $current_page, 'agency_mandants.php', 'Mandants',
            '<path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/>'); ?>
        <?php sbSI('mandats', $current_page, 'agency_mandats.php', 'Mandats',
            '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>'); ?>

        <div class="sb-sep" style="margin:6px 0"></div>
        <span class="sb-lbl">Réunions</span>
        <?php sbSI('reunions', $current_page, 'agency_reunions.php', 'Réunions / AG',
            '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>'); ?>
        <?php sbSI('taches', $current_page, 'agency_taches.php', 'Tâches',
            '<polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/>'); ?>

        <div class="sb-sep" style="margin:6px 0"></div>
        <span class="sb-lbl">Finances</span>
        <?php sbSI('contrats', $current_page, 'agency_contrats.php', 'Contrats',
            '<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>'); ?>
        <?php sbSI('factures', $current_page, 'agency_factures.php', 'Factures',
            '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>'); ?>

        <div class="sb-sep" style="margin:6px 0"></div>
        <span class="sb-lbl">Archives</span>
        <?php sbSI('registres', $current_page, 'agency_registres.php', 'Registres',
