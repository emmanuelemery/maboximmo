...
try {
    ...
    if ($filterStatut === 'actif')    { $oWhere[] = 'p.actif = 1'; }
  ...
  <div class="bl-content">
    ...
    <?php else: ?>
      ...
      <table class="ap-table">
        <thead>
          <tr>
            <th class="ap-sort" onclick="apSort(this,0)" style="cursor:pointer;">Nom <small style="color:#9a9690;font-weight:400;">· ID</small> <span class="ap-si">⇅</span></th>
            <th class="ap-sort" onclick="apSort(this,1)" style="cursor:pointer;">Type <span class="ap-si">⇅</span></th>
            <th class="ap-sort" onclick="apSort(this,2)" style="cursor:pointer;">Rôles <span class="ap-si">⇅</span></th>
            <th class="ap-sort" onclick="apSort(this,3)" style="cursor:pointer;">Contact <span class="ap-si">⇅</span></th>
            <th class="ap-sort" onclick="apSort(this,4)" style="cursor:pointer;">Agence <span class="ap-si">⇅</span></th>
            <th class="ap-sort" onclick="apSort(this,5)" style="text-align:center;cursor:pointer;">Biens <span class="ap-si">⇅</span></th>
            <th class="ap-sort" onclick="apSort(this,6)" style="text-align:center;cursor:pointer;">Mandats <span class="ap-si">⇅</span></th>
        ...
        <tbody>
          ...
          <tr class="<?= $isArchived ? 'is-archived' : '' ?>" data-id-tiers="<?= (int)$p['id_tiers'] ?>">
            <td>
              <?php if (!empty($pickBien) && $createUrl): ?>
              <a href="<?= e($createUrl) ?>" class="ap-link" title="Créer un bien pour ce propriétaire" style="font-weight:700;"><?= e($fullName) ?></a>
              <?php else: ?>
              ...
              <div style="margin-top:3px;display:flex;align-items:center;gap:6px;">
                <?php if ($isOrphelin): ?>
                  <code style="font-size:10.5px;color:#92400e;background:#fff3d6;padding:1px 6px;border-radius:4px;font-family:'DM Mono',monospace;border:1px solid #e8cf88;"
                        title="Propriétaire sans tiers (issu de l'import CRG) — visible en lecture, à rattacher à un tiers si besoin">⚠️ sans tiers</code>
                <?php else: ?>
            ...
            <td>
              <div class="ap-actions">
                <?php if (!empty($pickBien) && $createUrl): ?>
                  <a class="ap-action-btn" href="<?= e($createUrl) ?>" title="Créer un bien pour ce propriétaire" style="background:#5b21b6;color:#fff;">➕ Choisir</a>
                <?php endif; ?>
                <?php if ($p['id_proprio_legacy']): ?>
