<?php
// annonce_nouvelle.php — Redirection permanente vers bien_detail_v2.php
//
...
//   - Le flux complet création bien + annonce est dans `bien_detail_v2.php`
//     (sections documents / descriptif / dpe / annonce)
//   - Cette page n'est plus maintenue et plantait sur les INSERT/UPDATE
//
// Comportement : on redirige vers `bien_detail_v2.php?edit=X&section=annonce`
...
if ($idBien > 0) {
    header('Location: ' . app_url('/bien_detail_v2.php?edit=' . $idBien . '&section=annonce'), true, 301);
} else {
