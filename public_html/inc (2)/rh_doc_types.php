...
function rh_doc_rubriques_meta(): array {
    return [
        ...
        'agence'   => ['label' => 'Agence',    'color' => '#3d6e7d', 'rgb' => '61,110,125'],
...
function rh_doc_types_defaults(): array {
    return [
        ...
        ['rubrique'=>'societe','type_key'=>'rcp_transaction',   'label'=>'RC pro — Transaction (T)',       'obligatoire'=>1,'dispo'=>'public','ordre'=>10,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'rcp_gestion',       'label'=>'RC pro — Gestion (G)',           'obligatoire'=>1,'dispo'=>'public','ordre'=>11,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'rcp_syndic',        'label'=>'RC pro — Syndic (S)',            'obligatoire'=>0,'dispo'=>'public','ordre'=>12,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'rcp_marchand',      'label'=>'RC pro — Marchand de biens (M)', 'obligatoire'=>0,'dispo'=>'public','ordre'=>13,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'gf_transaction',    'label'=>'Garantie financière — Transaction','obligatoire'=>1,'dispo'=>'public','ordre'=>20,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'gf_gestion',        'label'=>'Garantie financière — Gestion',  'obligatoire'=>1,'dispo'=>'public','ordre'=>21,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'gf_syndic',         'label'=>'Garantie financière — Syndic',   'obligatoire'=>0,'dispo'=>'public','ordre'=>22,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'gf_marchand',       'label'=>'Garantie financière — Marchand', 'obligatoire'=>0,'dispo'=>'public','ordre'=>23,'systeme'=>1],
        ['rubrique'=>'societe','type_key'=>'assurance_soc',     'label'=>'Assurance société',              'obligatoire'=>0,'dispo'=>'public','ordre'=>30,'systeme'=>0],
        ['rubrique'=>'societe','type_key'=>'entete',            'label'=>'En-tête courrier',               'obligatoire'=>0,'dispo'=>'public','ordre'=>31,'systeme'=>0],
        // agence — barème honoraires + assurance MRI (par établissement)
        ['rubrique'=>'agence','type_key'=>'bareme_honoraires',  'label'=>'Barème honoraires',              'obligatoire'=>1,'dispo'=>'public','ordre'=>1, 'systeme'=>1],
        ['rubrique'=>'agence','type_key'=>'assurance_mri',      'label'=>'Assurance MRI (Multi-Risques)',  'obligatoire'=>1,'dispo'=>'public','ordre'=>2, 'systeme'=>1],
        // rh
