...
function extractPdfText(string $filepath): string
{
    ...
    // Cherche vendor/ : même niveau que inc/ → parent → grand-parent → racine Hostinger
...
PROMPT;
    ...
    if ($useNewParam) {
        $payloadArr['max_completion_tokens'] = 2048;
    } else {
        $payloadArr['max_tokens']  = 2048;
