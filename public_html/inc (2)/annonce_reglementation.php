...
function annonce_regles_location_seule(): array
{
    return [
        ...
        'champs_alertes' => [
            ...
            'honoraires_etat_des_lieux'=> 'Honoraires état des lieux plafonnés (3 €/m² zone tendue)',
        ],
        'mentions_interdites' => [
            'Honoraires supérieurs au plafond légal zone tendue (8, 10 ou 12 €/m² selon zone).',
        ...
        'points_vigilance' => [
            'Plafonnement des honoraires locataire : 8 €/m² (non tendue), 10 €/m² (tendue), 12 €/m² (très tendue).',
