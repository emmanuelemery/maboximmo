...
function analyseTitreIA(string $text): array
{
    ...
    $model = defined('OPENAI_TITRE_MODEL') ? OPENAI_TITRE_MODEL : 'gpt-4o-mini';
...
PROMPT;
    ...
    if ($httpCode !== 200) {
        ...
        error_log('[analyseTitreIA] HTTP ' . $httpCode . ' OpenAI : ' . $apiMsg);
        return ['ok' => false, 'fields' => [], 'doc_type' => 'titre',
