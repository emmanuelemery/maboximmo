...
function ubiflow_minimum_rules(): array
{
    return [
        ...
        // Nb lots : info commune à l'immeuble (scope='imm' → lit $bien['_imm_nb_lots']).
        ['key' => 'nb_lots',            'label' => 'Nombre de lots de la copropriété (à saisir sur la fiche immeuble)', 'scope' => 'imm', 'section' => 'alur',
