...
$dashUser    = $_sbBase . 'rh_dashboard_user.php';
$dashManager = $_sbBase . 'rh_dashboard.php';
...
<aside class="mbi-sidebar">
    ...
    <div class="sb-group dash">
        ...
        <ul class="sb-nav">
            <li><a href="<?= htmlspecialchars($dashUser) ?>" class="<?= sb_active('rh_dashboard_user.php') ?>"><span class="sb-icon">👤</span><span class="sb-label">Dashboard User</span></a></li>
            <li><a href="<?= htmlspecialchars($dashManager) ?>" class="<?= sb_active('rh_dashboard.php') ?>"><span class="sb-icon">🧭</span><span class="sb-label">Dashboard Manager</span></a></li>
            <?php if ($isAdminOrSup): ?>
