...
<div class="rh-user-banner">
    ...
    <p class="rh-banner-intro" style="margin-top:-4px">
        ⚡ <strong>Pour débloquer l'accès complet</strong>, trois conditions simples à remplir. Vous pouvez les faire dans l'ordre qui vous convient :
    </p>
    ...
    <div class="rh-banner-steps">
        <div class="rh-banner-step">
            ...
            <div>
                <span class="rh-banner-step-num">Condition 1</span>
                <span class="rh-banner-step-txt">Profil complété à 75 % minimum</span>
            </div>
        </div>
        <div class="rh-banner-step">
            <div class="rh-banner-step-ico">📄</div>
            <div>
                <span class="rh-banner-step-num">Condition 2</span>
                <span class="rh-banner-step-txt">Documents déposés à 50 % minimum</span>
            </div>
        </div>
        <div class="rh-banner-step">
            <div class="rh-banner-step-ico">🏖️</div>
            <div>
                <span class="rh-banner-step-num">Condition 3</span>
                <span class="rh-banner-step-txt">Historique de congés validé</span>
            </div>
        </div>
    </div>
